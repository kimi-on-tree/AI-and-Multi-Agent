...
namespace Imported.StandardAssets.Vehicles.Car.Scripts
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        [SerializeField] private static readonly int NoOfGears = 5;
        ...
        private void Start()
        {
            ...
            for (var i = 0; i < 4; i++) m_WheelMeshLocalRotations[i] = m_WheelMeshes[i].transform.localRotation;
        ...
        public void Move(float steering, float accel, float footbrake, float handbrake)
        {
            ...
            if (true || handbrake > 0f) // "true ||" is a bug fix, earlier car would require backing to release handbrake
            {
        ...
        private void ApplyDrive(float accel, float footbrake)
        {
            ...
            switch (m_CarDriveType)
            {
                case CarDriveType.FourWheelDrive:
                    ...
                    for (var i = 0; i < 4; i++) m_WheelColliders[i].motorTorque = thrustTorque;
                    break;
            ...
            for (var i = 0; i < 4; i++)
                ...
                else m_WheelColliders[i].brakeTorque = 0f;
        }
